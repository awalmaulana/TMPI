            ...
            <ul class="nav navbar-nav bookmark-icons">
                <li class="nav-item d-none d-lg-block">
                    <a class="navbar-brand" href="/dashboard">
                        <img src="{{ asset('app-assets/images/logo/LOGO_BSSN_2.png') }}" alt="avatar" height="40"
                            width="300">
                    </a>
                </li>
            </ul>
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#"
                    ...
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">Kabayan</span><span
                            class="user-status">Stakeholder</span></div>
                    <span class="avatar"><img class="round"
                            src="{{ asset('app-assets//images/portrait/small/avatar-s-11.jpg') }}" alt="avatar"
                            height="40" width="40"><span class="avatar-status-online"></span></span>
                </a>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    <a class="dropdown-item" href="/dashboard"><i class="me-50" data-feather="user"></i> Profile</a>
